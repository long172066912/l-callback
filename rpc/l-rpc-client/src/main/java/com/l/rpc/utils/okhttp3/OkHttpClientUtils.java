    ...
    public static Future<Response> sendAsync(String uri, String data) {
        ...
        call.enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                log.warn("OkHttp3Client send error !", e);
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) {
                if (!response.isSuccessful()) {
                    log.error("OkHttpUtils sendAsyncNoResponse fail ! response : {}", response.toString());
                }
                response.close();
            }
        });
    ...
    private enum OkHttpClientObject {
        ...
        OkHttpClientObject() {
            ...
            clientInstance = new OkHttpClient.Builder()
                    ...
                    .eventListener(RpcOkHttp3MetricsEventListener.builder(Metrics.globalRegistry, "okHttpRequests").build())
                    .build();
        }
