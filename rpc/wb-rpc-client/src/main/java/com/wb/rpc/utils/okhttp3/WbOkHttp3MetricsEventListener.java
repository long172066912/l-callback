 ...
 * doesn't provide URI patterns. We provide {@value WbOkHttp3MetricsEventListener#URI_PATTERN} header to support
...
@NonNullApi
@NonNullFields
public class WbOkHttp3MetricsEventListener extends EventListener {
    ...
    protected WbOkHttp3MetricsEventListener(MeterRegistry registry, String requestsMetricName, Function<Request, String> urlMapper,
    ...
    WbOkHttp3MetricsEventListener(MeterRegistry registry, String requestsMetricName, Function<Request, String> urlMapper,
                                  Iterable<Tag> extraTags,
                                  Iterable<BiFunction<Request, Response, Tag>> contextSpecificTags,
    ...
    public static class Builder {
        ...
        /**
         * Historically, OkHttp Metrics provided by {@link WbOkHttp3MetricsEventListener} included a
        ...
        public WbOkHttp3MetricsEventListener build() {
            return new WbOkHttp3MetricsEventListener(registry, name, uriMapper, tags, contextSpecificTags, requestTagKeys, includeHostTag);
        }
    }
}
