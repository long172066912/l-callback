package com.wb.base.callback.extend.callback.adapter.mq.wanba.platform;
 ...
 */
@Service
public class WbPlatformMqAdapter extends AbstractCallBackAdapter {

    private static WbLogger LOGGER = WbLoggerFactory.getLogger(WbPlatformMqAdapter.class);
    ...
    public CallBackStatus callBack(CallBackMessage callBackMessage) throws CallBackTimeoutException {
        LOGGER.info("玩吧平台mq方式回调， messageId : {}", callBackMessage.getMessageId());
        try {
