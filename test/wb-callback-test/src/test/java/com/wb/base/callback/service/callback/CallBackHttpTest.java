...
class CallBackHttpTest extends BaseTest {
     ...
     */
    @Test
    void callBackAsyncTest() throws Throwable {
        //开始消费
        callBackAsyncDispatch.asyncCallBack(BackPressureEnums.FAST, kafkaInnerQueue.poll());
        callBackAsyncDispatch.asyncCallBack(BackPressureEnums.SLOW, kafkaInnerQueue.poll());
    }
}