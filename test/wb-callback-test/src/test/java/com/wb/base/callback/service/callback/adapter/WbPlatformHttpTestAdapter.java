 ...
 */
@Service
public class WbPlatformHttpTestAdapter extends AbstractCallBackAdapter {

    private static WbLogger LOGGER = WbLoggerFactory.getLogger(WbPlatformHttpTestAdapter.class);
